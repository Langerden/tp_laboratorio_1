 ...
 *
 * \return Si el numeroUsuario es negativo o vale cero, devuelve 0. En caso de numeroUsuario ser un numero positivo me retorna el valor entero del factorial de numeroUsuario.
 */
